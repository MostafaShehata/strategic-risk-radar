...
from .run_windows import calculate_window
...
class IngestionRepository:
    ...
    def next_window(
        ...
        return calculate_window(end, row[0] if row else None, backfill_days, regular_window_minutes)

    def try_begin_source_run(
        self,
        config: dict[str, Any],
        source_id: str,
        source_type: str,
